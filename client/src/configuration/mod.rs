...
use crate::rpc::RpcImplConfiguration;
use cfx_types::H256;
use cfxcore::{
...
impl Configuration {
    ...
    pub fn local_http_config(&self) -> super::rpc::HttpConfiguration {
    ...
    pub fn http_config(&self) -> super::rpc::HttpConfiguration {
        super::rpc::HttpConfiguration::new(
            None,
    ...
    pub fn tcp_config(&self) -> super::rpc::TcpConfiguration {
        super::rpc::TcpConfiguration::new(None, self.raw_conf.jsonrpc_tcp_port)
    }

    pub fn ws_config(&self) -> super::rpc::WsConfiguration {
        super::rpc::WsConfiguration::new(None, self.raw_conf.jsonrpc_ws_port)
    }
