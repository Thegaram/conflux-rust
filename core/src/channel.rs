...
use primitives::log_entry::LocalizedLogEntry;
...
/// Implements a bounded MPMC broadcast channel.
...
pub struct Notifications {
    ...
    // TODO
    pub pivot_updates: Channel<H256>,

    // TODO
    pub logs_executed: Channel<Vec<LocalizedLogEntry>>,
}
...
impl Notifications {
    pub fn init() -> Arc<Self> {
        Arc::new(Notifications {
            ...
            pivot_updates: Channel::new("pivot-updates"),
            logs_executed: Channel::new("logs-executed"),
        })
    }
}
